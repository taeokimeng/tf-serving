...
from pages.image_classifier_page import display_image_classifier
from pages.tf_serving_page import display_tensorflow_serving

def page_image_classifier(state):
    display_image_classifier(state)

def page_tensorflow_serving(state):
    display_tensorflow_serving(state)
